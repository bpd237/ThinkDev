<?php
	...
	////////////////////////////////////////////////////////////////////// L A   L A N G U E
	if(!isset($_SESSION['thinkDev.lang'])) {
		if(isset($_GET['p'])) {
			$__tmp = stripcslashes(htmlspecialchars($_GET['p']));
			$__tmp = explode('.', $__tmp);
			$_SESSION['thinkDev.lang'] = $__tmp[0];
		} else {

			$_SESSION['thinkDev.lang'] = 'fr';
		}
	}

	if($_SESSION['thinkDev.lang'] == '*') {
		$_SESSION['thinkDev.lang'] = 'fr';
	}
	///////////////////////////////////////////////////////////////////// C H A N G E M E N T   D E   L A N G U E
	if(!empty($_POST)) {
		$_SESSION['thinkDev.lang'] = $_POST['lang'];
	}

	///////////////////////////////////////////////////////////////////// P E T I T   S Y S T E M E   D E   R O U T I N G
	$p = isset($_GET['p']) ? stripcslashes(htmlspecialchars($_GET['p'])) : $_SESSION['thinkDev.lang'].'.Page.Home.Index'; // récupération de la page à charger
	...
	$controller = '\MMBL_Bpd_237_work\Controller\\'.ucfirst($p[1]).'\\'.ucfirst($p[2]).'Controller'; // Appel du controleur correspondant
